- [Fundamental of PHP Development](#fundamental-of-php-development)
...
- [PHP Variable](#php-variable)
  ...
  - [PHP Data Types](#php-data-types)
    - [PHP is a loosely typed](#php-is-a-loosely-typed)
  ...
  - [Summary](#summary-1)
- [PHP Constant](#php-constant)
  - [define vs const](#define-vs-const)
  - [Summary](#summary-2)
- [PHP Control Structure](#php-control-structure)
...
- [PHP Function](#php-function)
  ...
  - [PHP Function from Javascript](#php-function-from-javascript)
  - [JavaScript Function from PHP](#javascript-function-from-php)
  - [Passing Arguments to a Function by Reference](#passing-arguments-to-a-function-by-reference)
  - [Understanding the Variable Scope](#understanding-the-variable-scope)
  - [Summary](#summary-5)
- [Working with Form](#working-with-form)
- [Working with Files and Directories with PHP](#working-with-files-and-directories-with-php)
  - [File open modes](#file-open-modes)
  - [Work With JSON In PHP](#work-with-json-in-php)
- [Object-Oriented Programming in PHP](#object-oriented-programming-in-php)
  - [Class \& Object](#class--object)
  - [Creating Objects in PHP](#creating-objects-in-php)
...
- [Error \& Exception Handling](#error--exception-handling)
  - [Ways to Handle PHP Errors](#ways-to-handle-php-errors)
- [Database with MySQL](#database-with-mysql)
- [MySQL with PDO](#mysql-with-pdo)
